...
#error OF_VID_GRABBER_TYPE is not #defined! 
	...
	if( RequestedDeviceID >= 0 ){
        cout<<RequestedDeviceID<<" requested device is\n";
...
//--------------------------------------------------------------------
/*void ofVideoGrabber::lockExposure() {
#ifdef TARGET_IPHONE
	grabber->lockCamExposure();
    cout<<"locked\n";
#endif
}*/
...
//--------------------------------------------------------------------
vector<string> ofVideoGrabber::returnDeviceNames(){
    if(	grabber != NULL ){
    return grabber->returnDeviceNames();
    }
}
//--------------------------------------------------------------------
